...
setup(name='unicore-cms-barefootlaw',
      version='0.1.0',
      ...
      url='http://github.com/universalcore/unicore-cms-barefootlaw',
      license='BSD',
      ...
      test_suite="unicorecmsbarefootlaw",
      entry_points="""\
      [paste.app_factory]
      main = unicorecmsbarefootlaw:main
      """,
      message_extractors={'.': [
          ('**.py', 'python', None),
          ('**.pt', 'chameleon', None),
